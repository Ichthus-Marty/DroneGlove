...
void GAM_Sensors::GAM_Gyro(int Gyro[]){
...
void GAM_Sensors::GAM_Magn(int Magn[]){
	Magn[0] = MPU9150_readSensor(MPU9150_CMPS_XOUT_L,MPU9150_CMPS_XOUT_H);
	Magn[1] = MPU9150_readSensor(MPU9150_CMPS_YOUT_L,MPU9150_CMPS_YOUT_H);
	Magn[2] = MPU9150_readSensor(MPU9150_CMPS_ZOUT_L,MPU9150_CMPS_ZOUT_H);
}
/*
void loop()
{
...
void GAM_Sensors::MPU9150_setupCompass(){
...
int GAM_Sensors::MPU9150_readSensor(int addrL, int addrH){
...
int GAM_Sensors::MPU9150_readSensor(int addr){
  Wire.beginTransmission(MPU9150_I2C_ADDRESS);
  Wire.write(addr);
  Wire.endTransmission(false);
...
int GAM_Sensors::MPU9150_writeSensor(int addr,int data){
  Wire.beginTransmission(MPU9150_I2C_ADDRESS);
  Wire.write(addr);
  Wire.write(data);
